...
public class ProgramDeclElemDerived4 extends ProgramDeclElem {

    private InterfaceDecl InterfaceDecl;

    public ProgramDeclElemDerived4 (InterfaceDecl InterfaceDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ProgramDeclElemDerived4(\n");
