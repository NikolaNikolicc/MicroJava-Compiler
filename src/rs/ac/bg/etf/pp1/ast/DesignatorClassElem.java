...
public class DesignatorClassElem implements SyntaxNode {
    ...
    public DesignatorClassElem (DesignatorArrayName DesignatorArrayName, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorClassElem(\n");
