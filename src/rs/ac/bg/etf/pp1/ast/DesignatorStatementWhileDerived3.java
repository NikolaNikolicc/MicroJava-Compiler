...
public class DesignatorStatementWhileDerived3 extends DesignatorStatementWhile {

    private DesignatorAssignWhile DesignatorAssignWhile;

    public DesignatorStatementWhileDerived3 (DesignatorAssignWhile DesignatorAssignWhile) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementWhileDerived3(\n");
