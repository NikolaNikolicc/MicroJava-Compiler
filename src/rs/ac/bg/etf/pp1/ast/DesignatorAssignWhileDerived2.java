...
public class DesignatorAssignWhileDerived2 extends DesignatorAssignWhile {
    ...
    public DesignatorAssignWhileDerived2 (Designator Designator, Assignop Assignop, Designator Designator1, Setop Setop, Designator Designator2) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorAssignWhileDerived2(\n");
