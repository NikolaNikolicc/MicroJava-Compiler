...
public class ClassDeclDerived8 extends ClassDecl {
    ...
    public ClassDeclDerived8 (String I1, Type Type, VarDeclListOptional VarDeclListOptional, ClassDeclErrorLBrace ClassDeclErrorLBrace, MethodDeclList MethodDeclList) {
        this.I1=I1;
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclDerived8(\n");
