...
public class DesignatorStatementUnarySemiWhile extends DesignatorStatementWhile {

    private Designator Designator;
    private DesignatorStatementUnary DesignatorStatementUnary;

    public DesignatorStatementUnarySemiWhile (Designator Designator, DesignatorStatementUnary DesignatorStatementUnary) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementUnarySemiWhile(\n");
