...
public class StatementLoopCondition extends Statement {
    ...
    public StatementLoopCondition (DoStatement DoStatement, Statement Statement, WhileStatement WhileStatement, Condition Condition, HandleWhileCondition HandleWhileCondition, GoToStart GoToStart) {
